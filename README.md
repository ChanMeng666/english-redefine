...
<a href="https://english-redefine.chanmeng-dev.workers.dev/">
  <img src="docs/showcase/hero.webp" alt="English Redefine Card Generator — clean single-page interface with an input field to enter an English word, a Generate redefine card button, and a rate-limit counter showing 5/5 requests remaining" width="100%">
</a>

![Demo: typing the word "serendipity" into the English Redefine Card Generator and clicking generate to produce an AI-powered modern interpretation card](docs/showcase/demo.gif)

<details>
<summary>📱 More screenshots</summary>

| Creator Card | Mobile View |
|---|---|
| <img src="docs/showcase/author-card.webp" width="520"> | <img src="docs/showcase/mobile-hero.webp" width="260"> |
